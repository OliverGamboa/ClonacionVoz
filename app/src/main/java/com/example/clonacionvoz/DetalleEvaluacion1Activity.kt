...
class DetalleEvaluacion1Activity : AppCompatActivity() {
    ...
    private fun mostrarGrafico(entradas: List<Entry>) {
        ...
        chart.setExtraOffsets(24f, 24f, 24f, 24f) // 🟢 margen interno verdadero
        chart.animateY(1500)
        chart.invalidate()
    }
