...
class Evaluacion5Activity : AppCompatActivity() {

    private var respuestasCorrectas = 0
    private var preguntasContestadas = BooleanArray(5) { false }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        onBackPressedDispatcher.addCallback(this, object : OnBackPressedCallback(true) {
            override fun handleOnBackPressed() {
                if (!evaluacionTerminada) {
                    val dialog = AlertDialog.Builder(this@Evaluacion5Activity)
        ...
        val preguntas = listOf(
            ...
            Triple(R.id.rgPregunta3, R.id.rb3a, R.id.feedback3),
            Triple(R.id.rgPregunta4, R.id.rb4a, R.id.feedback4),
            ...
            if (preguntasContestadas.contains(false)) {
                ...
                db.collection("evaluaciones")
                    ...
                    .addOnSuccessListener {
                        ...
                        val intent = Intent(this, ResultadoEvaluacion5Activity::class.java)
