...
class DetalleEvaluacion2Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_detalle_evaluacion2)
            ...
            .addOnSuccessListener { documentos ->
                ...
                for (doc in docs) {
                    ...
                    fun celdaBonita(t: String): TextView {
                        return TextView(this@DetalleEvaluacion2Activity).apply {
                            text = t
                            textSize = 22f
