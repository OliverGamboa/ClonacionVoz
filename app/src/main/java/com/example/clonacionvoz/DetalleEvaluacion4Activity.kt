...
class DetalleEvaluacion4Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_detalle_evaluacion4)
            ...
            .addOnSuccessListener { documentos ->
                ...
                for (doc in docs) {
                    ...
                    fun celdaBonita(t: String): TextView {
                        return TextView(this@DetalleEvaluacion4Activity).apply {
                            text = t
                            textSize = 22f
